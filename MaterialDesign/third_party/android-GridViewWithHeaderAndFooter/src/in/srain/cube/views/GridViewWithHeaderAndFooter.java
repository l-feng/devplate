...
public class GridViewWithHeaderAndFooter extends GridView {
    ...
    public boolean isInFooter(View view, int id) {
        if (view instanceof FullWidthFixedViewLayout) {
            for (int i = 0; i < ((FullWidthFixedViewLayout) view).getChildCount(); i++) {
                if (((FullWidthFixedViewLayout) view).getChildAt(i).getId() == id) {
                    return true;
                }
            }
        }

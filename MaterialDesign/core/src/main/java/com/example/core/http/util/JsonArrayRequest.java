...
public class JsonArrayRequest extends JsonRequest<JSONObject> {
    public JsonArrayRequest(int method, String url, String content, Listener<JSONObject> listener, ErrorListener errorListener) {
        super(method, url, content, listener, errorListener);
    }

...
public class ViewUtils {
    public static void setTitleBarColor(Activity activity) {
        setTitleBarColor(activity, R.color.green);
    }
...
//            window.addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
    ...
    public static boolean isLoadingViewShown(AbsListView listView) {
    ...
    public static void showToast(String message) {
        Toast.makeText(AppContext.getInstance().getContext().getApplicationContext(), message, Toast.LENGTH_LONG).show();
    }

    public static void showToast(String message, int length) {
        Toast.makeText(AppContext.getInstance().getContext().getApplicationContext(), message, length).show();
    }
    ...
    public static int getScreenHeight(Context context) {
        int height = AppContext.getInstance().getDeviceInfo().getHeightPixels() - getStatusBarHeight(context);
        return height;
    }

    public static int getScreenWidth() {
        int width = AppContext.getInstance().getDeviceInfo().getWidthPixels();
        return width;
    }
}

...
public class RefreshableListViewChild extends RefreshableView implements
    ...
    public RefreshableListViewChild(Context context) {
        super(context);
        init(context);
    }

    public RefreshableListViewChild(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
